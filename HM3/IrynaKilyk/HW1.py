Python_philosophy = """1.Beautiful is better than ugly.
...
count_of_better = Python_philosophy.lower().count("better")
count_of_never = Python_philosophy.lower().count("never")
count_of_is = Python_philosophy.lower().count("is")

print (f"The count of the word 'better' is {count_of_better}")
print (f"The count of the word 'never' is {count_of_never}")
print (f"The count of the word 'is' is {count_of_is}", end ="\n\n")

uppercase = Python_philosophy.upper()
print ("Python philosophy in uppercase:")
print(f"{uppercase}", end = "\n\n")

replace_symbol = uppercase.replace("I", "&")
print ("Replacing the 'I' with '&' in python philosophy")
print (f"{replace_symbol}", end = "\n\n")
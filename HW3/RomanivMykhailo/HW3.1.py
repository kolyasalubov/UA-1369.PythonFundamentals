...
better_count = zen_philosophy.count("better")
never_count = zen_philosophy.count("never")
is_count = zen_philosophy.count("is")
uppercase = zen_philosophy.upper()
zen_replaced = zen_philosophy.replace("i", "&")

#Results
print(f"'better' appears: {better_count} times")
print(f"'never' appears: {never_count} times")
print(f"'is' appears: {is_count} times")
print("\n")
print(zen_philosophy.upper())
print("\n")
print(zen_replaced)
...
print(f"Finded separately the number of occurrences of the words 'better' = {better_count}")
print(f"Finded separately the number of occurrences of the words 'never' = {never_count}")
print(f"Finded separately the number of occurrences of the words 'is' = {is_count}")


text_uppercase = python_philosophy.upper()
print(text_uppercase)


i_replace = python_philosophy.replace('i','&').replace('I','&')
print(i_replace)
